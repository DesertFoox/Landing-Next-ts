  ...
  return (
    <div className="bg-gradient-to-t from-[#E2F2FF] to-[#E7F4FF]">
      ...
      <div className="absolute bottom-0 right-[50px]">
        <Image src='/images/Group 2485.png' width={'312px'} height={'292px'} />
      </div>

      <div className="absolute bottom-0 left-[50px]">
        <Image src='/images/Group 2554.png' width={'312px'} height={'292px'} />
      </div>
      ...
      <div className="w-[668px] pt-[60px] bg-white rounded-xl mt-12 px-[52px] pb-[48px]">
        ...
        <div className="flex flex-col gap-2 w-full mt-12">
          <p className="text-[#222] text-[14px]">Which Related Problem You Are Facing?</p>
        ...
        <div className="flex flex-col gap-2 w-full mt-12">
          ...
          <textarea className="max-h-[100px] text-[13px] min-h-[100px] border-b border-[#E5E5E5] mt-3" placeholder="Lorem Ipsum is simply dummy text of the printing and...……."></textarea>
        </div>
